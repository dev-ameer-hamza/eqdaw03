...
public class Equipo {
     ...
     * @param nombreEquipo nombre equipo
     * @param puntos puntos
     * @param partidosJugados partidos jugados
     * @param partidosGanados partidos ganados
     * @param partidosPerdidos partidos perdidos
     * @param estado estado
     * @param listaPartidos lista partidos
     * @param listaJugadores lista jugadores
     */
